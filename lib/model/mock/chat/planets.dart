...
List<Planet> planets = [
  const Planet(
      ...
      description: '''
            ...
            planet in the Solar System after Mercury. In English, 
            Mars carries a name of the Roman god of war, and is often 
            referred to as the 'Red Planet' because the reddish iron oxide 
  ...
  const Planet(
      ...
      description: '''
            ...
            Neptune is 17 times the mass of Earth and is slightly more 
            massive than its near-twin Uranus, which is 15 times the mass 
            of Earth and slightly larger than Neptune. 
            Neptune orbits the Sun once every 164.8 years at an average 
  ...
  const Planet(
      ...
      description: '''
          ...
          Universe known to harbor life. According to radiometric 
